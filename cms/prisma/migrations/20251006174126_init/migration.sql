-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN', 'EDITOR', 'AUTHOR', 'CONTRIBUTOR', 'VIEWER');
...
CREATE TABLE "page_media" (
    ...
    CONSTRAINT "page_media_pkey" PRIMARY KEY ("pageId","mediaId")
);
...
-- AddForeignKey
ALTER TABLE "page_media" ADD CONSTRAINT "page_media_mediaId_fkey" FOREIGN KEY ("mediaId") REFERENCES "media"("id") ON DELETE CASCADE ON UPDATE CASCADE;
